  ...
  return (
    <section id="architecture" className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* 架构层级图 */}
        <div
          className="rounded-xl bg-white border border-gray-200 shadow-sm p-6 md:p-8 mb-6"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            {CENTERS.map((c) => (
              <div
                key={c.title}
                className="rounded-lg bg-white border-2 p-4 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-md"
              ...
              >
                ...
                <span className="text-xs text-gray-600 block">{c.desc}</span>
              </div>
            ))}
          </div>
